...
const Product = ({product}) => {
    ...
    return (
            ...
            <button className='w-4/5 mx-auto py-1 bg-orange-400 rounded-lg transform hover:duration-300 hover:bg-gray-100 hover:ring-2 hover:ring-orange-400  mb-3'>Add To Cart <FontAwesomeIcon icon={faCartPlus}/></button>
